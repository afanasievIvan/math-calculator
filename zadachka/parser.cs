...
namespace zadachka
{
    ...
    public class Operation
    {
        ...
        public bool exchange()
        {
            ...
            if (left != null)
            {
                if (left.right != null && right != null
                    && left.right.variable != null && right.variable == null && right.sign == '\0' && right.searchFunction == null)
                {
                    ...
                    && left.left.variable != null && right.variable == null && right.sign == '\0' && right.searchFunction == null)
                {
                    if (checkSign(this, left) == true)
                    {
        ...
        public void diffComplexFunc()
        {
            ...
            //  right = new Operation(parser, right.assembly());
            left = buffOp.copy();
            left.diff();
            cleanOperation();
            sign = '*';
